...
static void __free_privilege_list(GList* privilege_list)
{
    ...
    for (l = privilege_list; l != NULL; l = l->next)
    {
        ...
        if(privilege_info_db_row->version != NULL)
            free(privilege_info_db_row->version);
    }
}
...
static const char* __get_result_string(privilege_db_manager_error_e ret){
    ...
    else if(ret == PRIVILIEGE_DB_MANAGER_ERR_CONNECTION_FAIL){
        return "PRIVILIEGE_DB_MANAGER_ERR_CONNECTION_FAIL";
    }
    else if(ret == PRIVILIEGE_DB_MANAGER_ERR_INVALID_QUERY){
        return "PRIVILIEGE_DB_MANAGER_ERR_INVALID_QUERY";
    }
    else if(ret == PRIVILIEGE_DB_MANAGER_ERR_OUT_OF_MEMORY){
...
void __test_privilege_db_manager_get_privilege_list(){
    ...
    int ret = privilege_db_manager_get_privilege_list(&privilege_list);
    if(ret != PRIVILIEGE_DB_MANAGER_ERR_NONE){
...
void __test_privilege_db_manager_get_privilege_display(){
    ...
    printf("expected result : PRIVILIEGE_DB_MANAGER_ERR_NONE\n");
    ret = privilege_db_manager_get_privilege_display(PRIVILIEGE_DB_MANAGER_PACKAGE_TYPE_CORE, "http://tizen.org/privilege/location", "2.3", &privilege_display);
    __check_get_privilege_display_result(PRIVILIEGE_DB_MANAGER_ERR_NONE, ret, privilege_display);
    ...
    ret = privilege_db_manager_get_privilege_display(PRIVILIEGE_DB_MANAGER_PACKAGE_TYPE_WRT, "http://tizen.org/privilege/power", "2.3", &privilege_display);
    __check_get_privilege_display_result(PRIVILIEGE_DB_MANAGER_ERR_NONE, ret, privilege_display);
    free(privilege_display);

    printf("-----------------------------------------------------------\n");
    printf("privilege : http://tizen.org/privilege/messasdfsfsdfsdfad\n");
    printf("expected result : PRIVILIEGE_DB_NO_EXIST_RESULT\n");
    privilege_display = NULL;
    ret = privilege_db_manager_get_privilege_display(PRIVILIEGE_DB_MANAGER_PACKAGE_TYPE_CORE, "http://tizen.org/privilege/messasdfsfsdfsdfad", "2.3", &privilege_display);
    __check_get_privilege_display_result(PRIVILIEGE_DB_NO_EXIST_RESULT, ret, privilege_display);
    printf("-----------------------------------------------------------\n");
    free(privilege_display);
}
...
void __test_privilege_db_manager_get_privilege_description(){
    ...
    printf("privilege_type : core\n");
    printf("expected result : PRIVILIEGE_DB_MANAGER_ERR_NONE\n");
    ret = privilege_db_manager_get_privilege_description(PRIVILIEGE_DB_MANAGER_PACKAGE_TYPE_CORE, "http://tizen.org/privilege/location", "2.3", &privilege_display);
    __check_get_privilege_description_result(PRIVILIEGE_DB_MANAGER_ERR_NONE, ret, privilege_display);
    ...
    printf("privilege_type : wrt\n");
    printf("expected result : PRIVILIEGE_DB_MANAGER_ERR_NONE\n");
    ret = privilege_db_manager_get_privilege_description(PRIVILIEGE_DB_MANAGER_PACKAGE_TYPE_WRT, "http://tizen.org/privilege/power", "2.3", &privilege_display);
    __check_get_privilege_description_result(PRIVILIEGE_DB_MANAGER_ERR_NONE, ret, privilege_display);
    ...
    printf("privilege : http://tizen.org/privilege/messasdfsfsdfsdfad\n");
    printf("expected result : PRIVILIEGE_DB_NO_EXIST_RESULT\n");
    ret = privilege_db_manager_get_privilege_description(PRIVILIEGE_DB_MANAGER_PACKAGE_TYPE_CORE, "http://tizen.org/privilege/messasdfsfsdfsdfad", "2.3", &privilege_display);
    __check_get_privilege_description_result(PRIVILIEGE_DB_NO_EXIST_RESULT, ret, privilege_display);
    printf("-----------------------------------------------------------\n");
